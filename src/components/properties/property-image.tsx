...
const fallback = imagesByType.residential;

export function PropertyImage({ index, title, type }: { index: number; title: string; type?: string }) {
  const pool = (type && imagesByType[type.toLowerCase()]) || fallback;
